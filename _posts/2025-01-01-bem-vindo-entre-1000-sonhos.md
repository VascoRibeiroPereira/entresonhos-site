...
- pequenas crónicas e reflexões,
- apontamentos dos bastidores — cadernos, mapas, notas soltas.

Se quiseres acompanhar mais de perto:

- Lê histórias completas e capítulos no [Substack Entre Sonhos]({{ site.author.substack }}).  
- Vem espreitar o meu dia a dia de leitura e escrita em [@blog_entre_sonhos]({{ site.author.instagram }}).
